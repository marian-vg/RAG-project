"""
Tests estadisticos - Preguntas de integración con set_2
...
class TestIntegracionSet2:
    ...
    def test_pregunta_integracion(self, rag_engine_set2, pregunta_data):
        ...
        self.logger.log_result(
            test_name="test_integracion_set_2",

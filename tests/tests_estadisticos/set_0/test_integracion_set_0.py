"""
Tests estadisticos - Preguntas de integración con set_0
...
from tests.tests_estadisticos.preguntas_integracion import PREGUNTAS_INTEGRACION
from tests.registro_resultados import ResultsLogger


class TestIntegracionSet0:
    ...
    @pytest.mark.parametrize("pregunta_data", PREGUNTAS_INTEGRACION)
    def test_pregunta_integracion(self, rag_engine_set0, pregunta_data):
        ...
        self.logger.log_result(
            test_name="test_integracion_set_0",

"""
Tests estadisticos - Preguntas de integración con set_1
...
class TestIntegracionSet1:
    ...
    def test_pregunta_integracion(self, rag_engine_set1, pregunta_data):
        ...
        self.logger.log_result(
            test_name="test_integracion_set_1",
